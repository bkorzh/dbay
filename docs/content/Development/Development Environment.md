...
To connect to a control module, click on the Menu (three horizontal bars in the top-right) and then on *Re-initialize Source* . In the appearing box, enter the IP address of the control module (see [[Install the Control Module]] to find the IP).
